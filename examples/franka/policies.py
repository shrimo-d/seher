...
from controller_presets import ARS_REFERENCE, MPPI_BALANCED, ControllerConfig
...
def create_mppi_optimizer(
    n_candidates=MPPI_BALANCED.mppi_candidates,
    top_k=MPPI_BALANCED.mppi_top_k,
    initial_loc=0.0,
    initial_scale=MPPI_BALANCED.mppi_initial_scale,
    min_scale=MPPI_BALANCED.mppi_min_scale,
    temperature=MPPI_BALANCED.mppi_temperature,
):
...
def create_optimizer(
    ...
    *,
    ...
    top_k=ARS_REFERENCE.top_k,
    n_candidates=MPPI_BALANCED.mppi_candidates,
    mppi_top_k=MPPI_BALANCED.mppi_top_k,
    initial_loc=0.0,
    initial_scale=MPPI_BALANCED.mppi_initial_scale,
    min_scale=MPPI_BALANCED.mppi_min_scale,
    temperature=MPPI_BALANCED.mppi_temperature,
...
def create_mpc_policy_from_config(mdp, config: ControllerConfig):
    """Build an MPC policy from one fully resolved Franka controller config."""
